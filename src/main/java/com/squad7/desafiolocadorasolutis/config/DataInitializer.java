...
public class DataInitializer implements CommandLineRunner {
    ...
    private List<Car> createAndSaveCars(List<CarModel> carModels, List<Accessory> accessories) {
        Car c1 = carRepository.save(new Car(new BigDecimal("54.89"), "2JR cTUHG8 15 Bm8502", "HRK7697", carModels.get(0), List.of(accessories.get(3), accessories.get(0)), "https://midias.vrum.com.br/_midias/jpg/2024/01/11/honda_fit_1_4_flex_modelo_2007_cinza_de_frente_em_movimento_no_asfalto-34157751.jpg"));
        Car c2 = carRepository.save(new Car(new BigDecimal("62.89"), "4HS S6HNfw X2 Cy3255", "HDW6272", carModels.get(1), List.of(accessories.get(1), accessories.get(2), accessories.get(0)), "https://www.kbb.com/wp-content/uploads/2019/12/01-2018-Toyota-Camry-Exterior-KBB.jpg"));
        Car c3 = carRepository.save(new Car(new BigDecimal("89.99"), "1v8 A8Me9G Xy wg1769", "IZQ1019", carModels.get(2), List.of(accessories.get(4), accessories.get(2), accessories.get(0), accessories.get(3), accessories.get(1)), "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnUnWTXtJcoFQ91h5cX3WoFlXiSkvAhG5CSg&s"));
        Car c4 = carRepository.save(new Car(new BigDecimal("49.99"), "1ns C4CmkM zE Ht5333", "IZQ1018", carModels.get(3), List.of(accessories.get(0), accessories.get(3)), "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpX-vS21F5WAWsJBORGBWvbjx-4olaGXIR9Q&s"));
        Car c5 = carRepository.save(new Car(new BigDecimal("49.99"), "1v8 A8Me9G Xy wg1762", "NEY4708", carModels.get(4), List.of(accessories.get(0), accessories.get(3), accessories.get(1)), "https://image1.mobiauto.com.br/images/api/images/v1.0/52595736/transform/fl_progressive,f_webp,q_80"));
